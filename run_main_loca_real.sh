...
bash $neurocaasrootdir/locanmf/run.sh $bucketname $groupdir inputs $resultdir $resultdir/logs $dataname atlas.mat $configname > "$neurocaasrootdir"/joboutput.txt 2>"$neurocaasrootdir"/joberror.txt
##############################################
