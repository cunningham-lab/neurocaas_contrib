...
echo $remotedir "this is the remote directory. "
download () {
    python "$neurocaasrootdir/ncap_utils/transfer_codebase/Download_S3_single.py" "$1" "$2" "$3" 
}
...
upload () {
    python "$neurocaasrootdir/ncap_utils/transfer_codebase/Upload_S3.py" "$1" "$2" "$3" "$4" "$5"
}

download_folder () {
    python "$neurocaasrootdir/ncap_utils/transfer_codebase/Download_S3_folder.py" "$1" "$2" "$3" 
}
